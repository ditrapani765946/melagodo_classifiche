...
public class HtmlGenerator {
    ...
    public void generaSito(List<Gioco> giochi, String percorsoFile) {
        try (PrintWriter writer = new PrintWriter(new FileWriter(percorsoFile))) {
            ...
            writer.println("            color: var(--text-primary); padding: 40px 30px; text-align: left;");
            writer.println("            cursor: pointer; transition: all 0.2s ease;");
            writer.println("        }");
            ...
            writer.println("            color: var(--text-secondary); margin-bottom: 10px; text-transform: uppercase;");
            writer.println("        }");
            writer.println("        .tab-title {");
            writer.println("            display: block; font-family: 'Outfit', sans-serif;");
            writer.println("            font-size: 2.5rem; font-weight: 900; text-transform: uppercase;");
            writer.println("        }");
